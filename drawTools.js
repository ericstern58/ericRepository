...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		#drawTools-btn-icon-curve{position: relative;width: 12px;height: 12px;-webkit-box-shadow:-0px 3px 0px 0px black;box-shadow:-0px 3px 0px 0px black;border-radius:100%;}\n\
