...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		#drawTools-btn-icon-exit{width:5px;height:24px;margin:-2px 7px 0px 6px;background:red;-webkit-transform:skew(43deg);-moz-transform:skew(43deg);-o-transform:skew(43deg);transform:skew(43deg);}\n\
