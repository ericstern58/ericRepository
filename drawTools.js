...
function injectCSS() {
	...
	sheet.innerHTML = "\n\
		...
		.btnToolContainer:active,.btnTool input:focus+div{background-color:#f6f166;border-bottom:1px solid #f6f166;-webkit-box-shadow:inset 0 3px 5px rgba(0,0,0,0.125);box-shadow:inset 0 3px 5px rgba(0,0,0,0.125);}\n\
