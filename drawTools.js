...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		\n\
		#drawTools-options-palette input[type='radio']{display:none !important;}\n\
		#drawTools-options-palette input[type='radio']:checked + label{border:2px solid #c2c2c2;}\n\
		#drawTools-options-palette label{background:blue;width:36px;height:36px;line-height:2.428571429;border:2px solid #252525;position:relative;float:left;display:inline-block;}\n\
