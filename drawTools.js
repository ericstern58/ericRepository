...
cleanTools.html.init['setupCSS'] = function()
{
	...
	*/
	...
	DTSheet.innerHTML = "\n\
		...
		#drawTools-btn-icon-download:before{top:8px;left:-4px;position:absolute;border-left:10px solid transparent;border-right:10px solid transparent;border-top:9px solid #c2c2c2;content:"";}\n\
