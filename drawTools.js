...
cleanTools.html.init['setupCSS'] = function()
{
    ...
    DTSheet.innerHTML = "\n\
        ...
        #drawTools-btn-icon-curve{margin:6px 15px 0px 11px;position: relative;width: 12px;height: 12px;box-shadow:-0px 3px 0px 0px black;border-radius:100%;}\n\
        #drawTools-btn-icon-curve:after{margin:10px 0px 0px 10px;position:relative;width:8px;height:10px;box-shadow:0px -3px 0px 0px black;border-radius:100%;content:'';display:block;position:absolute;}\n\
        ...
        \n\
        .drawTools-btn{position:relative;float:left;display:inline-block;height:34px;border-radius:2px;margin-top:5px;}\n\
        .drawTools-btn:not(:first-child):not(:last-child):not(.dropdown-toggle){border-radius:0}\n\
        .drawTools-btn:first-child{margin-left:0;}\n\
        .drawTools-btn:first-child:not(:last-child):not(.dropdown-toggle){border-bottom-right-radius: 0;border-top-right-radius: 0;}\n\
        .drawTools-btn:last-child:not(:first-child),.dropdown-toggle:not(:first-child){border-bottom-left-radius:0;border-top-left-radius:0;}\n\
        \n\
        ...
        .drawTools-btn-container:active,.drawTools-btn input:focus + div,.drawTools-btn input:checked + div{background-color:#f6f166;border-bottom:1px solid #f6f166;box-shadow:inset 0 3px 5px rgba(0,0,0,0.5);}\n\
        .drawTools-btn-container.disabled,.drawTools-btn-container[disabled],fieldset[disabled] .drawTools-btn-container{cursor:not-allowed;pointer-events:none;opacity:0.65;filter:alpha(opacity=65);box-shadow:none;}\n\
        \n\
        ...
        #drawTools-btn-loop input[type='checkbox']:checked ~ #drawTools-btn-icon-loop {border:3px dotted #c2c2c2;background:#252525;box-shadow:none;}\n\
        \n\
        ...
        \n\
        .drawTools-menu{position:absolute;bottom:35px;padding:8px;margin:0;background:#252525;border-bottom:1px solid #171717;width:auto;height:175px;border-radius:2px 2px 0px 0px;opacity:0;z-index:99;box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);}\n\
        #drawTools-menu-content{position:relative;}\n\
        \n\
        #drawTools-menu-palette-parent{margin-left:-105px !important; padding:5px; width:250px; height:0;opacity:0;overflow:hidden;transition:all 200ms ease-out;}\n\
...
cleanTools.tools.paintMethods[" "] = function()
{
    var c = cleanTools;
...
cleanTools.html.init['createMenuPalette'] = function(drawToolsDiv, optionsButton)
{
    ...
    optionsDiv.id = cleanTools.id + '-menu-palette-parent';
