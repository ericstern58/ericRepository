...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		#drawTools-btn-icon-exit{margin:6px 12px 0px 12px;width:5px;height:21px;background:#c2c2c2;-webkit-transform:skew(43deg);-moz-transform:skew(43deg);-o-transform:skew(43deg);transform:skew(43deg);}\n\
