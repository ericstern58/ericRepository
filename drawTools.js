...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		#drawTools-btn-options .drawTools-btn-container:hover,#drawTools-btn-options .drawTools-btn:focus{background-color:#171717;border-bottom:1px solid #0e0e0e;}\n\
		#drawTools-btn-options .drawTools-btn-container:active,#drawTools-btn-options .drawTools-btn input:focus + div,#drawTools-btn-options .drawTools-btn input:checked + div{background-color:#171717;border-bottom:1px solid #171717;-webkit-box-shadow:inset 0 3px 5px rgba(0,0,0,0.125);box-shadow:inset 0 3px 5px rgba(0,0,0,0.125);}\n\
		\n\
		";
