...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		\n\
		#drawTools-options{margin:-196px 0px 0px 0px;background:#252525;border-bottom:1px solid #171717;width:300px;height:150px;padding:8px;position:absolute;border-radius:2px;opacity:1;-webkit-box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);-moz-box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);}\n\
		\n\
		";
