...
function setupCSS()
{
	...
	DTSheet.innerHTML = "\n\
		...
		\n\
		#drawTools-options{margin-top:-46px;background:#252525;border-bottom:1px solid #171717;width:300px;height:0px;padding:8px;position:absolute;border-radius:2px;opacity:0;overflow:hidden;-webkit-box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);-moz-box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);box-shadow:0px 0px 5px 0px rgba(0,0,0,0.75);}\n\
		\n\
		";
