...
ct.eh["mouseUp"]=function(e){var c=ct;var t=c.t;if(!ct.cd()){return;}if(t.c===t.tt.a){return;}else if(!t.ta){return;}c.mouseX=e.pageX-c.c.offset.left;c.mouseY=e.pageY-c.c.offset.top;var endPointX=c.mouseX;var endPointY=c.mouseY;if(t.c===t.tt.b){t.rs(true);}else if(t.c === t.tt.c){if(c.sd){var a=t.ls(t.p[0],t.p[1],endPointX,endPointY);endPointX = a.x;endPointY = a.y;}c.c.restore();t.pm.dl(c.cn,t.p[0],t.p[1], endPointX, endPointY);t.rs(true);}else if(t.c===t.tt.d){if(c.c.iwd(c.mouseX,c.mouseY)){if(c.sd){var a=t.ls(t.p[t.p.length-2],t.p[t.p.length-1],endPointX,endPointY);endPointX=a.x;endPointY=a.y;}t.p.push(endPointX,endPointY);if(e.which==3){var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;c.c.restore();t.pm.dc(c.cn,t.p,false,c.options.ltsc,fc);t.rs(true);}}else{c.c.restore();t.rs();}}else if(t.c===t.tt.e){if(c.c.iwd(c.mouseX,c.mouseY)){t.p.push(c.mouseX,c.mouseY);if(e.which==3){var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;c.c.restore();t.pm.ds(c.cn,t.p,0.5,c.options.ltsc,fc,false);t.rs(true);}}else{c.c.restore();t.rs();}}else if(t.c===t.tt.f){var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;if(c.sd){var a=t.ss(t.p[0],t.p[1],endPointX,endPointY);endPointX=a.x;endPointY=a.y;}c.c.restore();t.p.push(endPointX,endPointY);t.pm.dr(c.cn,t.p,fc);t.rs(true);}else if(t.c===t.tt.g){var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;if(c.sd){var a=t.ss(t.p[0],t.p[1],endPointX,endPointY);endPointX=a.x;endPointY=a.y;}c.c.restore();t.p.push(endPointX,endPointY);t.pm.de(c.cn,t.p,fc);t.rs(true);}}
ct.eh["keyDown"]=function(e){var c=ct;var t=c.t;if(!ct.cd()){return;}if(e.keyCode==16){c.sd=1;var endPointX=c.mouseX;var endPointY=c.mouseY;if(!t.ta){return;}else if(t.c===t.tt.f || t.c===t.tt.g){var a=t.ss(t.p[0],t.p[1],endPointX,endPointY);endPointX=a.x;endPointY=a.y;c.c.restore();var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;if(t.c === t.tt.f){t.pm.dr(c.cn,t.p.concat(endPointX,endPointY),fc);}else{t.pm.de(c.cn,t.p.concat(endPointX,endPointY),fc);}}else if(t.c===t.tt.c || t.c===t.tt.d){if(t.p.length>0){var a=t.ls(t.p[t.p.length-2],t.p[t.p.length-1],endPointX,endPointY);endPointX=a.x;endPointY=a.y;c.c.restore();if(t.c===t.tt.d){var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;t.pm.dc(c.cn,t.p.concat(endPointX,endPointY),true,c.options.ltsc,fc);}else{t.pm.dl(c.cn,t.p[0],t.p[1],endPointX,endPointY);}}}}else if(e.keyCode=="Q".charCodeAt(0)){if(t.c===t.tt.d || t.c===t.tt.e){if(t.p.length){t.p.length-=2;c.c.restore();if(t.p.length==0){t.rs();}else{var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;if(t.c===t.tt.d){t.pm.dc(c.cn,t.p.concat(c.mouseX,c.mouseY),true,c.options.ltsc,fc);}else{t.pm.ds(c.cn,t.p.concat(c.mouseX,c.mouseY),0.5,c.options.ltsc,fc,true);}}}}}}
ct.eh["keyUp"]=function(e){if(!ct.cd()){return;}var c=ct;var t=c.t;if(e.keyCode==16){c.sd=0;var endPointX=c.mouseX;var endPointY=c.mouseY;if(!t.ta){return;}if(t.c===t.tt.f || t.c===t.tt.g ){c.c.restore();var fc=(c.options.usaf)?c.cn.strokeStyle:c.options.fc;if(t.c === t.tt.f){t.pm.dr(c.cn,t.p.concat(endPointX,endPointY),fc);}else{t.pm.de(c.cn,t.p.concat(endPointX,endPointY),fc);}}else if(t.c===t.tt.c || t.c===t.tt.d){if(t.p.length>0){c.c.restore();if(t.c===t.tt.d){var fc=(c.options.usaf) ? c.cn.strokeStyle : c.options.fc;t.pm.dc(c.cn,t.p.concat(endPointX,endPointY),true,c.options.ltsc,fc);}else{t.pm.dl(c.cn,t.p[0],t.p[1],endPointX,endPointY);}}}}}
...
ct.cn.putImageData=CanvasRenderingContext2D.prototype.putImageData;ct.ht.init.setupCssAndHtml();ct.C.off('mousedown');ct.C.on('mousedown',ct.eh.mouseDown);$(document).off('mousemove');$(document).on('mousemove',ct.eh.mouseMove);$(document).off('mouseup');$(document).on('mouseup',ct.eh.mouseUp);$(document).keydown(ct.eh.keyDown);$(document).keyup(ct.eh.keyUp);
